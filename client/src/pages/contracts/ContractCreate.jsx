                      ...
                      return (
                        <>
                          <tr>
                            ...
                            <td className="py-2.5 px-4 text-right font-bold text-emerald-400">{baseAmount.toLocaleString('en-IN')}</td>
                          </tr>
                          {rules.map(rule => {
                            ...
                            return (
                              <tr key={rule.id}>
                                ...
                                <td className={`py-2.5 px-4 text-right ${rule.type === 'DEDUCTION' ? 'text-rose-400' : 'text-slate-200'}`}>
                                  {rule.type === 'DEDUCTION' ? '-' : ''}{calculatedAmount.toLocaleString('en-IN')}
                                </td>
                              </tr>
                            );
                          })}
                          <tr className="bg-[#1E293B]/30 font-bold">
                            ...
                            <td className="py-3 px-4 text-right text-[#5B8DEF] text-lg">{netAmount.toLocaleString('en-IN')}</td>
                          </tr>
                        </>
                      );
                    })()}
